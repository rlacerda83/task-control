...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn btn-success' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="toggle" title="%s">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '<button type="button" class="btn btn-success' + (this.options.iconSize == undefined ? '' : ' btn-' + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                '<div class="form-group pull-' + this.options.searchAlign + ' search">',
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            ...
            '<li class="page-first"><a href="javascript:void(0)"><i class="fa fa-angle-double-left"></i></a></li>',
            '<li class="page-pre"><a href="javascript:void(0)"><i class="fa fa-chevron-left"></i></a></li>');
        ...
        html.push(
            '<li class="page-next"><a href="javascript:void(0)"><i class="fa fa-chevron-right"></i></a></li>',
            '<li class="page-last"><a href="javascript:void(0)"><i class="fa fa-angle-double-right"></i></a></li>',
            '</ul>',
            '</div>');
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = that.options.cardView ?
                        ['<div class="card-view">',
                            ...
                            '</div>'].join('') :
                        [sprintf('<td %s %s %s %s data-title="%s">', id_, class_, style, data_, column.title),
                            value,
                            '</td>'].join('');
